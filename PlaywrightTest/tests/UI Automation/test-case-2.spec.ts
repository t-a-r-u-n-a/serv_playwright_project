...
test('Search TV, add TV to shopping cart, navigate to cart page', async ({ }) => {
  ...
  await cartPage.assertProductInCart(4, firstProduct);
  await cartPage.assertProductInCart(3, secondProduct);
  await cartPage.assertProductInCart(2, thirdProduct);
  ...
  await viewcartpage.checkAvailability('3000', 'Melbourne VIC 3000');
